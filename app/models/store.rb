class Store < ApplicationRecord
  ...
  class << self
    ...
    def open_at(weektime)
      ...
      store_ids = joins(:business_hours).where('(business_hours.opentime < ? and business_hours.closetime >= ?) or (business_hours.opentime < ? and business_hours.closetime >= ?)', weektime, weektime, large_weektime, large_weektime).pluck(:id)
      where(id: store_ids)
    end
